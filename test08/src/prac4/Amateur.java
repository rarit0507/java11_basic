...
public class Amateur implements Gamer {
	...
	public void jump(int height) {
		if(height>MAX_HEIGHT) System.out.println("아마추어의 점프 높이는 "+MAX_HEIGHT+"를 넘을 수 없습니다.");
		else System.out.println("현재 속도는 "+height+"입니다.");
	}
	...
	public void show(String name) {
		System.out.println("아마추어 게이머"+name+" 님이 게임중입니다.");
	}
